...
This repository contains a hardened, honest workshop-only robotics paper draft for `micro_slip_precontact_prediction`.
...
Canonical local PDF path: `C:/Users/wangz/Downloads/91.pdf`
