...
\usepackage{url}
\usepackage{booktabs}
\title{Micro-Slip Precontact Prediction: ICLR Main-Conference Gate Archive}
\author{Anonymous Authors}
\begin{document}
\maketitle
\begin{abstract}
This document is not an ICLR main-conference submission. It is the v3 main-conference gate for a generated robotics draft about tactile and force prediction. The original research bet was: Predict micro-slip risk before stable contact is visually apparent. After a stricter hostile review, the honest terminal decision is \textbf{KILL/ARCHIVE}. Submission-hardening version: v3.
\end{abstract}
...
\begin{itemize}
\item Tactile sensor-less fingertip contact detection and force estimation for stable grasping with an under-actuated hand (2024)
\item Tactile-Driven Grasp Stability and Slip Prediction (2019)
\item A Soft Barometric Tactile Sensor to Simultaneously Localize Contact and Estimate Normal Force With Validation to Detect Slip in a Robotic Gripper (2022)
\item Leveraging distributed contact force measurements for slip detection: a physics-based approach enabled by a data-driven tactile sensor (2022)
\item Physical model of electrical contact friction for wear failure analysis and prediction of aerospace slip rings (2026)
\end{itemize}
