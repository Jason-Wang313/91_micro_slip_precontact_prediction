...
Honest strongest claim: `Predict micro-slip risk before stable contact is visually apparent.` is a plausible branch-structured mechanism for tactile and force prediction, supported by synthetic multi-seed diagnostic evidence and hostile-prior-work-aware positioning.
